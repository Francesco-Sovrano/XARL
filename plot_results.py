...
parser.add_argument('-t', '--step_type', dest='step_type', type=str, default='num_env_steps_sampled', help="num_env_steps_sampled, num_env_steps_trained, num_agent_steps_sampled, num_agent_steps_trained")
