...
# SELECT_ENV = "BreakoutNoFrameskip-v4"
# SELECT_ENV = "GridDrive-Har
SELECT_ENV = "MinecraftEnv-V1"

CONFIG = QMIX_DEFAULT_CONFIG.copy()
...
CONFIG.update({
	...
	"rollout_fragment_length": 2**2, # Divide episodes into fragments of this many steps each during rollouts. Default is 1.
	"train_batch_size": 2**5, # Number of transitions per train-batch. Default is: 100 for TD3, 256 for SAC and DDPG, 32 for DQN, 500 for APPO.
	...
	'buffer_size': 2**5, # Size of the experience buffer. Default 50000
...
train(QMixTrainer, CONFIG, SELECT_ENV, test_every_n_step=1e7, stop_training_after_n_step=2e7)
