...
CONFIG.update({
	...
	"buffer_options": {
		...
		'global_size': 2**15, # Default 50000. Maximum number of batches stored in all clusters (whose number depends on the clustering scheme) of the experience buffer. Every batch has size 'replay_sequence_length' (default is 1).
...
for k,v in get_model_catalog_dict('ddpg', CONFIG["framework"]).items():
