...
class Which_CoopStrategy(InfoExplanation):
	def __init__(self, agent_action_sliding_window=16, **args):
		...
		super().__init__('which-coop-strategy', **args)
		print(f'[which-coop-strategy] agent_action_sliding_window={agent_action_sliding_window}')
		self.agent_action_sliding_window = agent_action_sliding_window
