...
register_env(f"MAGraphDrive-PVComm", lambda config: PVCommMultiAgentGraphDrive({"reward_fn": 'frequent_reward_no_culture', "culture_level": "Easy", **config}))
register_env(f"MAGraphDrive-PVComm-Sparse", lambda config: PVCommMultiAgentGraphDrive({"reward_fn": 'sparse_reward_no_culture', "culture_level": "Easy", **config}))
